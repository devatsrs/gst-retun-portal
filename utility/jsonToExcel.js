...
var sheetHeaders = {
  ...
  atadj:
    "Summary For Adjustment of advance tax paid earlier for reverse charge supplies (10 B) ",
  exemp:
    "Summary For Composition, Nil rated, exempted and non GST inward supplies (7)",
...
var b2bHeaderL4G1Er = [
  ...
  "POS List",
  "Error Code",
  "Mandatory Check Field(Please DO NOT Update/Delete)",
];

var b2baHeaderL4G1Er = [
  "GSTIN/UIN of Recipient",
  "Receiver Name",
...
var cdnraHeaderL4G1Er = [
  "GSTIN/UIN of Recipient",
  "Receiver Name",
  "Original Note/Refund Voucher Number",
  "Original Note/Refund Voucher date",
  "Original Invoice/Advance Receipt Number",
  "Original Invoice/Advance Receipt date",
...
var b2bHeaderL4G1 = [
  ...
  "Action",
  "Mandatory Check Field(Please DO NOT Update/Delete)",
  "Mandatory Unique Num Identifier(Please DO NOT Update/Delete)",
  "UPDTP Data(Please DO NOT Update/Delete)",
  "POS List",
];
...
var b2clHeaderL4G1 = [
  ...
  "Mandatory Check Field(Please DO NOT Update/Delete)",
  "Mandatory Unique Num Identifier(Please DO NOT Update/Delete)",
  "Flag Data(Please DO NOT Update/Delete)",
  "POS List",
];
...
var UQCList = [
  ...
  { value: "BGS", name: "BGS-BAGS" },
  { value: "BKL", name: "BKL-BUCKLES" },
  { value: "BOU", name: "BOU-BOU" },
  { value: "BOX", name: "BOX-BOX" },
  { value: "BTL", name: "BTL-BOTTLES" },
  { value: "BUN", name: "BUN-BUNCHES" },
  { value: "CBM", name: "CBM-CUBIC METER" },
  { value: "CCM", name: "CCM-CUBIC CENTIMETER" },
  { value: "CIN", name: "CIN-CUBICINCHES" },
  { value: "CMS", name: "CMS" },
  { value: "CQM", name: "CQM-CUBIC METERS" },
  { value: "CTN", name: "CTN-CARTON" },
  { value: "DOZ", name: "DOZ-DOZEN" },
  { value: "DRM", name: "DRM-DRUM" },
  { value: "FTS", name: "FTS-FEET" },
  { value: "GGR", name: "GGR-GREAT GROSS" },
  { value: "GMS", name: "GMS-GRAMS" },
  { value: "GRS", name: "GRS-GROSS" },
  { value: "GYD", name: "GYD-GROSS YARDS" },
  { value: "HKS", name: "HKS-HANKS" },
  { value: "INC", name: "INC-INCHES" },
  { value: "KGS", name: "KGS-Kilograms" },
  { value: "KLR", name: "KLR-KILOLITRE" },
  { value: "KME", name: "KME-KILOMETERS" },
  { value: "LBS", name: "LBS-POUNDS" },
  { value: "LOT", name: "LOT-LOTS" },
  { value: "LTR", name: "LTR-LITERS" },
  { value: "MGS", name: "MGS-MILLI GRAMS" },
  { value: "MTR", name: "MTR-METER" },
  { value: "MLT", name: "MLT-MILLI LITRES" },
  { value: "MTS", name: "MTS-METRIC TON" },
  { value: "NOS", name: "NOS-Numbers" },
  { value: "ODD", name: "ODD-ODDS" },
  { value: "PAC", name: "PAC-PACKS" },
  { value: "PCS", name: "PCS-Pieces" },
  { value: "PRS", name: "PRS-PAIRS" },
  { value: "QTL", name: "QTL-QUINTAL" },
  { value: "ROL", name: "ROL-ROLLS" },
  { value: "SDM", name: "SDM-DECAMETER SQUARE" },
  { value: "SET", name: "SET-SETS" },
  { value: "SHT", name: "SHT-SHEETS" },
  { value: "SQF", name: "SQF-SQUARE FEET" },
  { value: "SQI", name: "SQI-SQUARE INCHES" },
  { value: "SQM", name: "SQM-SQUARE METER" },
  { value: "SQY", name: "SQY-SQUARE YARDS" },
  { value: "TBS", name: "TBS-TABLETS" },
  { value: "THD", name: "THD-THOUSANDS" },
  { value: "TOL", name: "TOL-TOLA" },
  { value: "TON", name: "TON-GREAT BRITAIN TON" },
  { value: "TUB", name: "TUB-TUBES" },
  { value: "UGS", name: "UGS-US GALLONS" },
  { value: "UNT", name: "UNT-UNITS" },
  { value: "VLS", name: "VLS-Vials" },
...
var styleL4 = workbook.createStyleSheetXML({
  font: {
    family: "roman",
    size: 11,
  },
...
var styleL1L2 = workbook.createStyleSheetXML({
  font: {
    family: "roman",
    size: 11,
    color: "#FFFFFF",
...
var writeJSONToExcel = function (filename, form, type, _callback) {
  ...
  for (var section in json) {
    if (
      (allSectionsArray.indexOf(section) > -1 ||
        allSectionsArrayG1.indexOf(section) > -1) &&
      (json[section].length > 0 || Object.keys(json[section]).length > 0)
    ) {
  ...
  sectionNameArray.forEach(function (section) {
    if (section.toLowerCase() == "imp_g") {
      ...
      section.toLowerCase() == "nil_supplies" ||
      section.toLowerCase() == "nil"
    ) {
    ...
    if (form == "GSTR2") {
      switch (sectionNameArray[i]) {
        case "b2b":
          ...
          json[sectionNameArray[i]].forEach(function (props) {
            ...
            var currSuppName = "";
            if (props.hasOwnProperty("cname")) currSuppName = props["cname"];

            //console.log(obj['inv'].length);
            props["inv"].forEach(function (invoice) {
              var currInvValue = 0.0;
              ...
              var currFlag = "";
              if (invoice.hasOwnProperty("flag")) currFlag = invoice["flag"];
              var currChckSum = "";
              if (invoice.hasOwnProperty("chksum"))
                currChckSum = invoice["chksum"];
              var currUpdByTP = "";
              if (currFlag == "U") currUpdByTP = "U";
        ...
        case "imp_s":
          ...
          json[sectionNameArray[i]].forEach(function (item) {
            ...
            var currPos = "";
            if (item.hasOwnProperty("pos")) currPos = getFullPOS(item["pos"]);
            var currInvNum = item["inum"];
            item["itms"].forEach(function (innerItem) {
              writeIMPSDataToExcel(
                currInvValue,
                currInvDate,
                currPos,
                currInvNum,
        ...
        case "cdn":
          ...
          json[sectionNameArray[i]].forEach(function (props) {
            ...
            props["nt"].forEach(function (note) {
              ...
              var currInvNum = "";
              if (note.hasOwnProperty("inum")) currInvNum = note["inum"];
              var currInvDate = "";
              if (note.hasOwnProperty("idt")) currInvDate = note["idt"];
              var currPreGST = "";
              if (note.hasOwnProperty("p_gst")) currPreGST = note["p_gst"];
              var currDocType = "";
              if (note.hasOwnProperty("ntty")) currDocType = note["ntty"];
              var currReason = "";
              if (note.hasOwnProperty("rsn")) currReason = note["rsn"];
              var currNoteValue = 0.0;
              if (note.hasOwnProperty("val")) currNoteValue = note["val"];
              var currFlag = note["flag"];
              var currChckSum = "";
              if (note.hasOwnProperty("chksum")) currChckSum = note["chksum"];
              var currUpdByTP = "";
              if (currFlag == "U") currUpdByTP = "U";
        ...
        case "cdnur":
          ...
          json[sectionNameArray[i]].forEach(function (item) {
            ...
            var currInvNum = "";
            if (item.hasOwnProperty("inum")) currInvNum = item["inum"];
            var currInvDate = "";
            if (item.hasOwnProperty("idt")) currInvDate = item["idt"];
            var currInvType = "";
            if (item.hasOwnProperty("inv_typ")) currInvType = item["inv_typ"];
            var currPreGST = "";
            if (item.hasOwnProperty("p_gst")) currPreGST = item["p_gst"];
            var currDocType = "";
            if (item.hasOwnProperty("ntty")) currDocType = item["ntty"];
            var currReason = "";
            if (item.hasOwnProperty("rsn")) currReason = item["rsn"];
            var currNoteValue = "";
            if (item.hasOwnProperty("val")) currNoteValue = item["val"];
            var currSuppType = "";
            if (item.hasOwnProperty("sp_typ")) currSuppType = item["sp_typ"];

            item["itms"].forEach(function (innerItem) {
              writeCDNURDataToExcel(
                currNoteNum,
                currNoteDate,
                currInvNum,
                currInvDate,
      ...
      switch (sectionNameArray[i]) {
        case "b2b":
          ...
          json[sectionNameArray[i]].forEach(function (props) {
            ...
            props["inv"].forEach(function (invoice) {
              ...
              var currETIN = "";
              if (invoice.hasOwnProperty("etin")) currETIN = invoice["etin"];
              ...
              var currUpdBy = "";
              if (invoice.hasOwnProperty("updby")) currUpdBy = invoice["updby"];
              // if (currFlag == 'U')
              //     currUpdBy = 'U';

              invoice["itms"].forEach(function (item) {
                writeB2BDataToExcelG1(
                  currSheet,
                  currCtin,
                  currSuppName,
                  currStatus,
        ...
        case "b2cl":
          ...
          json[sectionNameArray[i]].forEach(function (props) {
            var currPos = "";
            if (props.hasOwnProperty("pos")) currPos = getFullPOS(props["pos"]);
            //console.log(obj['inv'].length);
            props["inv"].forEach(function (invoice) {
              //console.log(invoice);
        ...
        case "b2cs":
          ...
          json[sectionNameArray[i]].forEach(function (invoice) {
            ...
            var currType = "";
            if (invoice.hasOwnProperty("typ")) currType = invoice["typ"];
        ...
        case "cdn":
          ...
          json[sectionNameArray[i]].forEach(function (props) {
            ...
            props["nt"].forEach(function (note) {
              ...
              if (note.hasOwnProperty("chksum")) currChckSum = note["chksum"];
              var currUpdBy = "";
              if (note.hasOwnProperty("updby")) currUpdBy = note["updby"];

              var currSuppType = "";
              if (note.hasOwnProperty("sp_typ")) currSuppType = note["sp_typ"];

              var currFlag = "";
              if (note.hasOwnProperty("flag")) currFlag = note["flag"];
              /*var currCFlag = '';*/
        ...
        case "cdnur":
          ...
          json[sectionNameArray[i]].forEach(function (item) {
            var currUrType = "";
            if (item.hasOwnProperty("typ")) currUrType = item["typ"];
            var currNoteNum = item["nt_num"];
            var currNoteDate = item["nt_dt"];
            var currInvNum = "";
            if (item.hasOwnProperty("inum")) currInvNum = item["inum"];
            ...
            if (item.hasOwnProperty("val")) currNoteValue = item["val"];
            var currFlag = "";
            if (item.hasOwnProperty("flag")) currFlag = flags[item["flag"]];
            var currSuppType = "";
            if (item.hasOwnProperty("sp_typ")) currSuppType = item["sp_typ"];
        ...
        case "at":
          ...
          json[sectionNameArray[i]].forEach(function (item) {
            ...
            var currChckSum = "";
            if (item.hasOwnProperty("chksum")) currChckSum = item["chksum"];
        ...
        case "exp":
          for (var col = 1; col <= exportsHeaderL4G1.length; col++) {
            currSheet
              .cell(4, col)
              .string(exportsHeaderL4G1[col - 1])
              .style(styleL4);
          }
          //To hide checksum, num and UpdBy columns
          currSheet.column(13).hide();
        ...
        case "expa":
          for (var col = 1; col <= exportsamendHeaderL4G1.length; col++) {
            currSheet
              .cell(4, col)
              .string(exportsamendHeaderL4G1[col - 1])
              .style(styleL4);
          }
          //To hide checksum, num and UpdBy columns
          currSheet.column(15).hide();
      ...
      switch (sectionNameArray[i]) {
        ...
        case "b2cla":
          for (var col = 1; col <= b2claHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(b2claHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
          currSheet.column(14).hide();
        ...
        case "b2csa":
          for (var col = 1; col <= b2csaHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(b2csaHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
          currSheet.column(12).hide();
        ...
        case "cdna":
          for (var col = 1; col <= cdnraHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(cdnraHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide checksum, num and UpdBy columns
          currSheet.column(19).hide();
        ...
        case "cdnur":
          for (var col = 1; col <= cdnurHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(cdnurHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide  column
          currSheet.column(16).hide();
        ...
        case "cdnura":
          for (var col = 1; col <= cdnuraHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(cdnuraHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
        ...
        case "txpd":
          for (var col = 1; col <= atadjHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(atadjHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
          currSheet.column(8).hide();
        ...
        case "txpda":
          for (var col = 1; col <= atadjaHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(atadjaHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
          currSheet.column(10).hide();
        ...
        case "hsn":
          for (var col = 1; col <= hsnsumHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(hsnsumHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide num column
          currSheet.column(11).hide();
        ...
        case "exp":
          for (var col = 1; col <= exportsHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(exportsHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide checksum, num and UpdBy columns
          currSheet.column(14).hide();
        ...
        case "expa":
          for (var col = 1; col <= exportsamendHeaderL4G1Er.length; col++) {
            currSheet
              .cell(4, col)
              .string(exportsamendHeaderL4G1Er[col - 1])
              .style(styleL4);
          }
          //To hide checksum, num and UpdBy columns
          currSheet.column(16).hide();
...
function writeB2BDataToExcel(
  ...
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("rt"))
    currSheet
      .cell(rowPtr, 9)
      .string(Number(item["itm_det"]["rt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 9).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("txval"))
    currSheet
      .cell(rowPtr, 10)
      .string(Number(item["itm_det"]["txval"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 10).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("iamt"))
    currSheet
      .cell(rowPtr, 11)
      .string(Number(item["itm_det"]["iamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 11).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("camt"))
    currSheet
      .cell(rowPtr, 12)
      .string(Number(item["itm_det"]["camt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 12).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("samt"))
    currSheet
      .cell(rowPtr, 13)
      .string(Number(item["itm_det"]["samt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 13).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("csamt"))
    currSheet
      .cell(rowPtr, 14)
      .string(Number(item["itm_det"]["csamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 14).string("0.00");
  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("elg"))
    currSheet
      .cell(rowPtr, 15)
      .string(getFullItcElig(item["itc"]["elg"]).toString());
  else currSheet.cell(rowPtr, 15).string("");
  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("tx_i"))
    currSheet
      .cell(rowPtr, 16)
      .string(Number(item["itc"]["tx_i"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 16).string("0.00");

  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("tx_c"))
    currSheet
      .cell(rowPtr, 17)
      .string(Number(item["itc"]["tx_c"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 17).string("0.00");

  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("tx_s"))
    currSheet
      .cell(rowPtr, 18)
      .string(Number(item["itc"]["tx_s"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 18).string("0.00");

  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("tx_cs"))
    currSheet
      .cell(rowPtr, 19)
      .string(Number(item["itc"]["tx_cs"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 19).string("0.00");

  if (currStatus == "Y") {
    if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
      currSheet.cell(rowPtr, 20).string("");
    else currSheet.cell(rowPtr, 20).string("Submitted");
  } else {
    if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
      currSheet.cell(rowPtr, 20).string("");
    else currSheet.cell(rowPtr, 20).string("Saved");
  }
...
function writeB2BURDataToExcel(
  currSuppName,
  currInvValue,
  currInvDate,
  currSuppType,
  ...
  currSheet
    .cell(rowPtr, 4)
    .string(parseFloat(currInvValue).toFixed(2).toString());
  currSheet.cell(rowPtr, 5).string(currPos.toString());
  if (currSuppType == "INTRA") currSheet.cell(rowPtr, 6).string("Intra State");
  ...
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("rt"))
    currSheet
      .cell(rowPtr, 7)
      .string(Number(item["itm_det"]["rt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 7).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("txval"))
    currSheet
      .cell(rowPtr, 8)
      .string(Number(item["itm_det"]["txval"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 8).string("0.00");
  if (item.hasOwnProperty("itm_det") && item["itm_det"].hasOwnProperty("iamt"))
    currSheet
      .cell(rowPtr, 9)
      .string(Number(item["itm_det"]["iamt"]).toFixed(2).toString());
  ...
  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("elg"))
    currSheet
      .cell(rowPtr, 13)
      .string(getFullItcElig(item["itc"]["elg"]).toString());
  else currSheet.cell(rowPtr, 13).string("");
  ...
  if (item.hasOwnProperty("itc") && item["itc"].hasOwnProperty("tx_c"))
    currSheet
      .cell(rowPtr, 15)
      .string(Number(item["itc"]["tx_c"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 15).string("0.00");
  ...
  else currSheet.cell(rowPtr, 19).string("");
  ++rowPtr;
}

function writeIMPSDataToExcel(
  currInvValue,
  currInvDate,
  currPos,
  currInvNum,
  ...
  currSheet
    .cell(rowPtr, 2)
    .string(getFormattedDate(currInvDate).toString())
  ...
  currSheet
    .cell(rowPtr, 5)
    .string(Number(innerItem["rt"]).toFixed(2).toString());
  currSheet
    .cell(rowPtr, 6)
    .string(Number(innerItem["txval"]).toFixed(2).toString());
  currSheet
    .cell(rowPtr, 7)
    .string(Number(innerItem["iamt"]).toFixed(2).toString());
  if (innerItem.hasOwnProperty("csamt"))
    currSheet
      .cell(rowPtr, 8)
      .string(Number(innerItem["csamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 8).string("0.00");
  ...
  if (innerItem.hasOwnProperty("tx_i"))
    currSheet
      .cell(rowPtr, 10)
      .string(Number(innerItem["tx_i"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 10).string("0.00");

  if (innerItem.hasOwnProperty("tx_cs"))
    currSheet
      .cell(rowPtr, 11)
      .string(Number(innerItem["tx_cs"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 11).string("0.00");
...
function writeIMPGDataToExcel(
  ...
  currSheet
    .cell(rowPtr, 3)
    .string(getFormattedDate(currBillEDate).toString())
    .style({ numberFormat: "dd-mmm-yy" });
  currSheet
    .cell(rowPtr, 4)
    .string(parseFloat(currBillEValue).toFixed(2).toString());
  ...
  currSheet
    .cell(rowPtr, 11)
    .string(getFullItcElig(innerItem["elg"]).toString());
...
function writeCDNDataToExcel(
  ...
  currSheet
    .cell(rowPtr, 11)
    .string(Number(currNoteValue).toFixed(2).toString());
  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("rt")
  )
    currSheet
      .cell(rowPtr, 12)
      .string(Number(innerItem["itm_det"]["rt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 12).string("0.00");

  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("txval")
  )
    currSheet
      .cell(rowPtr, 13)
      .string(Number(innerItem["itm_det"]["txval"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 13).string("0.00");
  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("iamt")
  )
    currSheet
      .cell(rowPtr, 14)
      .string(Number(innerItem["itm_det"]["iamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 14).string("0.00");
  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("camt")
  )
    currSheet
      .cell(rowPtr, 15)
      .string(Number(innerItem["itm_det"]["camt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 15).string("0.00");
  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("samt")
  )
    currSheet
      .cell(rowPtr, 16)
      .string(Number(innerItem["itm_det"]["samt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 16).string("0.00");
  if (
    innerItem.hasOwnProperty("itm_det") &&
    innerItem["itm_det"].hasOwnProperty("csamt")
  )
    currSheet
      .cell(rowPtr, 17)
      .string(Number(innerItem["itm_det"]["csamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 17).string("0.00");

  currSheet
    .cell(rowPtr, 18)
    .string(getFullItcElig(innerItem["itc"]["elg"]).toString());

  if (
    innerItem.hasOwnProperty("itc") &&
    innerItem["itc"].hasOwnProperty("tx_i")
  )
    currSheet
      .cell(rowPtr, 19)
      .string(Number(innerItem["itc"]["tx_i"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 19).string("0.00");

  if (
    innerItem.hasOwnProperty("itc") &&
    innerItem["itc"].hasOwnProperty("tx_c")
  )
    currSheet
      .cell(rowPtr, 20)
      .string(Number(innerItem["itc"]["tx_c"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 20).string("0.00");

  if (
    innerItem.hasOwnProperty("itc") &&
    innerItem["itc"].hasOwnProperty("tx_s")
  )
    currSheet
      .cell(rowPtr, 21)
      .string(Number(innerItem["itc"]["tx_s"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 21).string("0.00");

  if (
    innerItem.hasOwnProperty("itc") &&
    innerItem["itc"].hasOwnProperty("tx_cs")
  )
    currSheet
      .cell(rowPtr, 22)
      .string(Number(innerItem["itc"]["tx_cs"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 22).string("0.00");

  if (currStatus == "Y") {
    if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
      currSheet.cell(rowPtr, 23).string("");
    else currSheet.cell(rowPtr, 23).string("Submitted");
  } else {
    if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
      currSheet.cell(rowPtr, 23).string("");
    else currSheet.cell(rowPtr, 23).string("Saved");
  }

  //currSheet.cell(rowPtr,23).string(flags[currFlag].toString());
  if (currFlag === undefined) currSheet.cell(rowPtr, 24).string("");
  else currSheet.cell(rowPtr, 24).string(flags[currFlag].toString());
  currSheet.cell(rowPtr, 26).string(currChkSum);
  if (innerItem.hasOwnProperty("num"))
    currSheet.cell(rowPtr, 27).string(innerItem["num"].toString());
  else currSheet.cell(rowPtr, 27).string("");
  currSheet.cell(rowPtr, 28).string(currUpdByTP);
  ++rowPtr;
}

function writeCDNURDataToExcel(
  currNoteNum,
  currNoteDate,
  currInvNum,
  currInvDate,
  ...
  else currSheet.cell(rowPtr, 23).string("");
  ++rowPtr;
}
...
function writeHSNSUMDataToExcel(item) {
  ...
  else currSheet.cell(rowPtr, 1).string("");
  if (item.hasOwnProperty("desc"))
    currSheet.cell(rowPtr, 2).string(item["desc"]);
  else currSheet.cell(rowPtr, 2).string("");
  ...
  else currSheet.cell(rowPtr, 4).string("0");
  if (item.hasOwnProperty("val"))
    currSheet.cell(rowPtr, 5).string(Number(item["val"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 5).string("0.00");

  if (item.hasOwnProperty("txval"))
    currSheet
      .cell(rowPtr, 6)
      .string(Number(item["txval"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 6).string("0.00");

  if (item.hasOwnProperty("iamt"))
    currSheet
      .cell(rowPtr, 7)
      .string(Number(item["iamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 7).string("0.00");

  if (item.hasOwnProperty("camt"))
    currSheet
      .cell(rowPtr, 8)
      .string(Number(item["camt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 8).string("0.00");

  if (item.hasOwnProperty("samt"))
    currSheet
      .cell(rowPtr, 9)
      .string(Number(item["samt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 9).string("0.00");

  if (item.hasOwnProperty("csamt"))
    currSheet
      .cell(rowPtr, 10)
      .string(Number(item["csamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 10).string("0.00");

  if (item.hasOwnProperty("num"))
    currSheet.cell(rowPtr, 12).string(item["num"].toString());
  else currSheet.cell(rowPtr, 12).string("");
  ++rowPtr;
}
...
function writeITCRDataToExcel(itcrJson) {
  ...
  for (var rule in rules) {
    ...
    if (ruleIndex < 5) currSheet.cell(rowPtr, 2).string("To be added");
    else if (ruleIndex < 7) currSheet.cell(rowPtr, 2).string("To be reduced");
    else currSheet.cell(rowPtr, 2).string("");
    //console.log(rule);
    ...
    if (itcrJson[rule].hasOwnProperty("iamt"))
      currSheet
        .cell(rowPtr, 3)
        .string(Number(itcrJson[rule]["iamt"]).toFixed(2).toString());
    else currSheet.cell(rowPtr, 3).string("0.00");

    if (itcrJson[rule].hasOwnProperty("camt"))
      currSheet
        .cell(rowPtr, 4)
        .string(Number(itcrJson[rule]["camt"]).toFixed(2).toString());
    else currSheet.cell(rowPtr, 4).string("0.00");

    if (itcrJson[rule].hasOwnProperty("samt"))
      currSheet
        .cell(rowPtr, 5)
        .string(Number(itcrJson[rule]["samt"]).toFixed(2).toString());
    else currSheet.cell(rowPtr, 5).string("0.00");

    if (itcrJson[rule].hasOwnProperty("csamt"))
      currSheet
        .cell(rowPtr, 6)
        .string(Number(itcrJson[rule]["csamt"]).toFixed(2).toString());
    else currSheet.cell(rowPtr, 6).string("0.00");
  ...
  for (var type in nilJson) {
    if (nilJson.hasOwnProperty(type)) {
      ...
      if (nilJson[type].hasOwnProperty("cpddr"))
        currSheet
          .cell(rowPtr, 2)
          .string(Number(nilJson[type]["cpddr"]).toFixed(2).toString());
      else currSheet.cell(rowPtr, 2).string("0.00");

      if (nilJson[type].hasOwnProperty("nilsply"))
        currSheet
          .cell(rowPtr, 3)
          .string(Number(nilJson[type]["nilsply"]).toFixed(2).toString());
      else currSheet.cell(rowPtr, 3).string("0.00");

      if (nilJson[type].hasOwnProperty("exptdsply"))
        currSheet
          .cell(rowPtr, 4)
          .string(Number(nilJson[type]["exptdsply"]).toFixed(2).toString());
      else currSheet.cell(rowPtr, 4).string("0.00");

      if (nilJson[type].hasOwnProperty("ngsply"))
        currSheet
          .cell(rowPtr, 5)
          .string(Number(nilJson[type]["ngsply"]).toFixed(2).toString());
      else currSheet.cell(rowPtr, 5).string("0.00");
...
function writeTXIDataToExcel(currPos, currSuppType, innerItem) {
  ...
  if (currSuppType == "INTRA") currSheet.cell(rowPtr, 2).string("Intra State");
  else if (currSuppType == "INTER")
  ...
  if (innerItem.hasOwnProperty("adamt"))
    currSheet
      .cell(rowPtr, 4)
      .string(Number(innerItem["adamt"]).toFixed(2).toString());
  else currSheet.cell(rowPtr, 4).string("0.00");
  ...
  else currSheet.cell(rowPtr, 7).string("");
  ++rowPtr;
}
...
function writeB2BDataToExcelG1(
  currSheet,
  currCtin,
  currSuppName,
  currStatus,
  ...
  else currSheet.cell(rowPtr, 14).string("");
  // }
  /*else {
        if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
...
function writeB2BADataToExcelG1(
  currSheet,
  currCtin,
  currSuppName,
  currStatus,
  ...
  else currSheet.cell(rowPtr, 16).string("");
  // }
  /*else {
        if (currFlag == "U" || currFlag == "D" || currFlag === undefined)
            currSheet.cell(rowPtr, 14).string("");
...
function writeB2CLDataToExcelG1(
  currInvValue,
  currInvDate,
  currETIN,
  currPos,
...
function writeB2CLADataToExcelG1(
  currInvValue,
  currInvDate,
  currETIN,
  currPos,
...
function writeB2CSDataToExcelG1(
  currTxValue,
  currCSAmount,
  currETIN,
  currSuppType,
...
function writeB2CSADataToExcelG1(
  currTxValue,
  currCSAmount,
  currETIN,
  currSuppType,
...
function writeCDNDataToExcelG1(
  currCtin,
  currSuppName,
  currStatus,
  currNoteNum,
  ...
  else currSheet.cell(rowPtr, 18).string("");
  currSheet.cell(rowPtr, 19).string(currUpdBy);
  ++rowPtr;
}

function writeCDNADataToExcelG1(
  currCtin,
  currSuppName,
  currStatus,
  currNoteNum,
  ...
  else currSheet.cell(rowPtr, 17).string("");
  ...
  else currSheet.cell(rowPtr, 20).string("");
  currSheet.cell(rowPtr, 21).string(currUpdBy);
  ++rowPtr;
}

function writeCDNURDataToExcelG1(
  currUrType,
  currNoteNum,
  currNoteDate,
  currInvNum,
...
function writeCDNURADataToExcelG1(
  currUrType,
  oldNoteNum,
  oldNoteDate,
  currNoteNum,
...
function writeExpDataToExcelG1(
  currSheet,
  currEType,
  currChckSum,
  currInvNum,
...
function writeExpaDataToExcelG1(
  currSheet,
  currEType,
  currChckSum,
  currInvNum,
...
function writeNilDataToExcelG1(currChckSum, nilItem) {
  ...
  if (nilItem.hasOwnProperty("nil_amt")) {
    currSheet
      .cell(rowPtr, 2)
      .string(Number(nilItem["nil_amt"]).toFixed(2).toString());
  } else {
  ...
  if (nilItem.hasOwnProperty("expt_amt")) {
    currSheet
      .cell(rowPtr, 3)
      .string(Number(nilItem["expt_amt"]).toFixed(2).toString());
  } else {
  ...
  if (nilItem.hasOwnProperty("ngsup_amt")) {
    currSheet
      .cell(rowPtr, 4)
      .string(Number(nilItem["ngsup_amt"]).toFixed(2).toString());
  } else {
...
function writeTXIDataToExcelG1(
  currPos,
  currSuppType,
  currChckSum,
  currFlag,
  ...
  else currSheet.cell(rowPtr, 8).string("");

  ++rowPtr;
}

function writeATXIDataToExcelG1(
  currPos,
  currSuppType,
  currChckSum,
  currFlag,
  ...
  else currSheet.cell(rowPtr, 10).string("");

  ++rowPtr;
}
function writeATADJDataToExcelG1(
  currPos,
  currSuppType,
  currChckSum,
  currFlag,
...
function writeATADJADataToExcelG1(
  currPos,
  currSuppType,
  currChckSum,
  currFlag,
...
function getFullUQC(uqcCode) {
  ...
  UQCList.forEach(function (uqc) {
    if (uqc.value == uqcCode) fullUQC = uqc.name;
  });
  return fullUQC;
}
  ...
  switch (sheetName) {
    case "b2b":
      currSheet
        .cell(1, 20, 1, 22, true)
        .string(
          "Submitted: Supplier has submitted the invoices in the portal;\nSaved: Supplier has saved, but haven’t yet submitted the invoices in the portal"
        )
        .style(styleL4);
    ...
    case "cdnr":
      ...
      currSheet
        .cell(1, 18, 1, 22, true)
        .string(
          "Default ITC eligibility as inputs for credit and debit notes needs to be updated as per the linked invoice place of supply (POS) to avoid ‘Invalid ITC eligibility’ error upon upload of records to GST Portal"
        )
        .style(styleL4);
    ...
    case "itcr":
      ...
      currSheet
        .cell(2, 4)
        .string("Total ITC Central Tax Amount")
        .style(styleL1L2);
      currSheet
        .cell(2, 5)
  ...
  switch (section) {
    case "b2b":
      currSheet
        .cell(3, 1)
        .formula(
          '=SUMPRODUCT((A5:A19999<>"")/COUNTIF(A5:A19999,A5:A19999&""))'
        );
      currSheet
        .cell(3, 2)
        .formula(
          '=SUMPRODUCT((B5:B19999<>"")/COUNTIF(B5:B19999,B5:B19999&""))'
        );
      currSheet
        .cell(3, 4)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(B5:B19999,B5:B19999&""),0+(D5:D19999)),2)'
        );
    ...
    case "b2bur":
      currSheet
        .cell(3, 2)
        .formula(
          '=SUMPRODUCT((B5:B19976<>"")/COUNTIF(B5:B19976,B5:B19976&""))'
        );
      currSheet
        .cell(3, 4)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(B5:B19976,B5:B19976&""),0+(D5:D19976)),2)'
        );
    ...
    case "imps":
      currSheet
        .cell(3, 1)
        .formula(
          '=SUMPRODUCT((A5:A10004<>"")/COUNTIF(A5:A10004,A5:A10004&""))'
        );
      currSheet
        .cell(3, 3)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(A5:A10004,A5:A10004&""),0+(C5:C10004)),2)'
        );
    ...
    case "impg":
      currSheet
        .cell(3, 2)
        .formula(
          '=SUMPRODUCT((B5:B10004<>"")/COUNTIF(B5:B10004,B5:B10004&""))'
        );
      currSheet
        .cell(3, 4)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(B5:B10004,B5:B10004&""),0+(D5:D10004)),2)'
        );
      currSheet.cell(3, 8).formula("=FIXED(SUMPRODUCT((H5:H20004)*1),2)");
      currSheet.cell(3, 9).formula("=FIXED(SUMPRODUCT((I5:I20004)*1),2)");
      currSheet.cell(3, 10).formula("=FIXED(SUMPRODUCT((J5:J20004)*1),2)");
    ...
    case "cdnr":
      currSheet
        .cell(3, 1)
        .formula(
          '=SUMPRODUCT((A5:A10001<>"")/COUNTIF(A5:A10001,A5:A10001&""))'
        );
      currSheet
        .cell(3, 2)
        .formula(
          '=SUMPRODUCT((B5:B10001<>"")/COUNTIF(B5:B10001,B5:B10001&""))'
        );
      currSheet
        .cell(3, 4)
        .formula(
          '=SUMPRODUCT((D5:D10001<>"")/COUNTIF(D5:D10001,D5:D10001&""))'
        );
      currSheet
        .cell(3, 10)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(B5:B10001,B5:B10001&""),0+(J5:J10001)),2)'
        );
      currSheet.cell(3, 12).formula("=FIXED(SUMPRODUCT((L5:L20004)*1),2)");
      currSheet.cell(3, 13).formula("=FIXED(SUMPRODUCT((M5:M20004)*1),2)");
      currSheet.cell(3, 14).formula("=FIXED(SUMPRODUCT((N5:N20004)*1),2)");
    ...
    case "cdnur":
      ...
      currSheet
        .cell(3, 3)
        .formula(
          '=SUMPRODUCT((C5:C10001<>"")/COUNTIF(C5:C10001,C5:C10001&""))'
        );
      currSheet
        .cell(3, 9)
        .formula(
          '=FIXED(SUMPRODUCT(1/COUNTIF(A5:A10001,A5:A10001&""),0+(I5:I10001)),2)'
        );
      currSheet.cell(3, 11).formula("=FIXED(SUMPRODUCT((K5:K20004)*1),2)");
      currSheet.cell(3, 12).formula("=FIXED(SUMPRODUCT((L5:L20004)*1),2)");
      currSheet.cell(3, 13).formula("=FIXED(SUMPRODUCT((M5:M20004)*1),2)");
    ...
    case "hsnsum":
      currSheet
        .cell(3, 1)
        .formula('=SUMPRODUCT((A5:A2004<>"")/COUNTIF(A5:A2004,A5:A2004&""))');
  ...
  switch (section) {
    case "b2b":
      ...
      currSheet.addDataValidation({
        ...
        allowBlank: 1,
        sqref: "I5:I20004",
        formulas: ["0.00,0.25,3.00,5.00,12.00,18.00,28.00"],
      });
      currSheet.addDataValidation({
        type: "list",
        allowBlank: 1,
        sqref: "O5:O20004",
        formulas: ["Inputs,Capital goods,Input services,Ineligible"],
      });
      ...
      currSheet.addDataValidation({
        ...
        allowBlank: 1,
        sqref: "V5:V20004",
        formulas: ["Accept,Reject,Modify,Pending,Add,Edit,Delete"],
      });
    ...
    case "b2bur":
      currSheet.addDataValidation({
        ...
        allowBlank: 1,
        sqref: "F5:F20004",
        formulas: ["Inter State,Intra State"],
      });
      currSheet.addDataValidation({
        type: "list",
        allowBlank: 1,
    ...
    case "impg":
      currSheet.addDataValidation({
        ...
        allowBlank: 1,
        sqref: "E5:E20004",
        formulas: ["Imports,Received from SEZ"],
      });
      currSheet.addDataValidation({
        type: "list",
        allowBlank: 1,
      ...
      currSheet.addDataValidation({
        ...
        allowBlank: 1,
        sqref: "K5:K20004",
        formulas: ["Inputs,Capital goods,Ineligible"],
      });
      currSheet.addDataValidation({
        type: "list",
        allowBlank: 1,
    ...
    case "cdnr":
      ...
      currSheet.addDataValidation({
        ...
        sqref: "I5:I20004",
        formulas: [
          "01-Sales Return,02-Post Sale Discount,03-Deficiency in services,04-Correction in Invoice,05-Change in POS,06-Finalization of Provisional assessment,07-Others",
        ],
      });
      currSheet.addDataValidation({
        type: "list",
...
function writeB2BDataToExcelG1Er(
  currSheet,
  currCtin,
  currSuppName,
  currInvValue,
...
function writeB2BADataToExcelG1Er(
  currSheet,
  currCtin,
  currSuppName,
  currInvValue,
  ...
  currSheet
    .cell(rowPtr, 20)
    .string(
      currCtin + "_" + oldInvNum.toString() + "_" + currInvNum.toString()
    );
  ++rowPtr;
}
function writeB2CLDataToExcelG1Er(
  currInvValue,
  currInvDate,
  currETIN,
  currPos,
  ...
  currSheet
    .cell(rowPtr, 14)
    .string(currPos.substring(0, 2) + "_" + currInvNum.toString());
  ++rowPtr;
}

function writeB2CLADataToExcelG1Er(
  currInvValue,
  currInvDate,
  currETIN,
  currPos,
...
function writeCDNDataToExcelG1Er(
  currCtin,
  currSuppName,
  currNoteNum,
  currNoteDate,
...
function writeCDNADataToExcelG1Er(
  currCtin,
  currSuppName,
  currNoteNum,
  currNoteDate,
  ...
  currSheet
    .cell(rowPtr, 20)
    .string(
      currCtin + "_" + oldNoteNum.toString() + "_" + currNoteNum.toString()
    );

  ++rowPtr;
}

function writeCDNURDataToExcelG1Er(
  currUrType,
  currNoteNum,
  currNoteDate,
  currInvNum,
...
function writeCDNURADataToExcelG1Er(
  currUrType,
  oldNoteNum,
  oldNoteDate,
  currNoteNum,
  ...
  currSheet
    .cell(rowPtr, 19)
    .string(oldNoteNum.toString() + "_" + currNoteNum.toString());

  ++rowPtr;
}

function writeB2CSDataToExcelG1Er(
  currTxValue,
  currCSAmount,
  currETIN,
  currSuppType,
  ...
  currSheet
    ...
    .string(
      currPos.substring(0, 2) +
        ...
        currETIN +
        "_" +
        currDiffPerc.toString()
    );

  ++rowPtr;
}

function writeB2CSADataToExcelG1Er(
  currTxValue,
  currCSAmount,
  currETIN,
  currSuppType,
...
function writeExpDataToExcelG1Er(
  currSheet,
  currEType,
  currInvNum,
  currInvValue,
...
function writeExpaDataToExcelG1Er(
  currSheet,
  currEType,
  currInvNum,
  currInvValue,
  ...
  currSheet
    .cell(rowPtr, 17)
    .string(
      currEType + "_" + oldInvNum.toString() + "_" + currInvNum.toString()
    );
...
function writeTXIDataToExcelG1Er(
  currPos,
  currSuppType,
  currDiffPerc,
  currErrorMsg,
  ...
  currSheet
    .cell(rowPtr, 10)
    .string(currPos.substring(0, 2) + "_" + currDiffPerc.toString());
  ++rowPtr;
}

function writeATXIDataToExcelG1Er(
  currPos,
  currSuppType,
  currDiffPerc,
  oldMonth,
...
function writeATADJDataToExcelG1Er(
  currPos,
  currSuppType,
  currDiffPerc,
  currErrorMsg,
...
function writeATADJADataToExcelG1Er(
  currPos,
  currSuppType,
  currDiffPerc,
  oldMonth,
